...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    // not granted.
    private final LatLng mDefaultLocation = new LatLng(33.786218, -118.110196);
                    ...
                    (new OnCompleteListener<PlaceLikelihoodBufferResponse>() {
                        ...
                        public void onComplete(@NonNull Task<PlaceLikelihoodBufferResponse> task) {
                            if (task.isSuccessful() && task.getResult() != null) {
                                ...
                                for (PlaceLikelihood placeLikelihood : likelyPlaces) {
                                    // Build a list of likely places to show the user.
                                        ...
                                        if(placeLikelihood.getPlace().getName() != null) {
                                            testName.add(mLikelyPlaceNames[i]);
                               ...
                               // View v ;
                                //v = LinearLayout.inflate(R.layout.content_main,null,);
                                //TextView temp = (TextView) findViewById(R.id.main_restaurantDescriptionTxt);
                                MainActivity.main.setText(testName.get(0));
                                //temp.setText("test");
                                //TextView temp = findViewById(R.id.main_restaurantDescriptionTxt);
                                //temp.setText(testName.get(0));
    ...
    public void changeName()
    {
        ...
        TextView temp = findViewById(R.id.main_restaurantDescriptionTxt);
        temp.setText(GetNeabyPlacesData.names.get(0));
    }
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        //googlePlaceUrl.append("&key="+"AIzaSyA3EI3SVnuXJyeXNunpyuaUIlcQNyAD5YM");
